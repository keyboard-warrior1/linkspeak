...
class ProfileLoading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: <Widget>[
      Container(
          child: ListView(physics: _neverScrollable, children: <Widget>[
                ...
                child: ClipRRect(
                    ...
                    child: Container(
                        ...
                        child: ConstrainedBox(
                            constraints:
                                BoxConstraints(minHeight: 500, maxHeight: 500),
                            child: Column(
        ...
        Container(color: Colors.white, child: const PostsLoading(false))
      ]))
    ]);
  }
}
