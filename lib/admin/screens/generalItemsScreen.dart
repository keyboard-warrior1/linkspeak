...
class _GeneralItemsScreenState extends State<GeneralItemsScreen>
  ...
  String buildBarName() {
    ...
    if (widget.isProfiles) return lang.admin_generalItemBar1;
    if (widget.isClubs) return lang.admin_generalItemBar2;
    if (widget.isPosts) return lang.admin_generalItemBar3;
    if (widget.isPostComments) return lang.admin_generalItemBar4;
    if (widget.isPostCommentReplies) return lang.admin_generalItemBar5;
    if (widget.isFlares) return lang.admin_generalItemBar6;
    if (widget.isFlareComments) return lang.admin_generalItemBar7;
    if (widget.isFlareCommentReplies) return lang.admin_generalItemBar8;
    return '';
  }
