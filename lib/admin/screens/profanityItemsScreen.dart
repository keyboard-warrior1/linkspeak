...
class _ProfanityItemsScreenState extends State<ProfanityItemsScreen> {
  ...
  String buildBarTitle() {
    ...
    if (widget.isProfileBio) return lang.admin_profanityBar1;
    if (widget.isClubAbout) return lang.admin_profanityBar2;
    if (widget.isFlareProfileBio) return lang.admin_profanityBar3;
    if (widget.isPostDescription) return lang.admin_profanityBar4;
    if (widget.isPostComments) return lang.admin_profanityBar5;
    if (widget.isPostCommentReplies) return lang.admin_profanityBar6;
    if (widget.isFlareComments) return lang.admin_profanityBar7;
    if (widget.isFlareCommentReplies) return lang.admin_profanityBar8;
    return lang.admin_profanityBar9;
  }
