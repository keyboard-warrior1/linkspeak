...
class _ProhibitDialogState extends State<ProhibitDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    String? durationValidation(String? value) {
      ...
      if (value!.isEmpty ||
          value.replaceAll(' ', '') == '' ||
          value.trim() == '') return '* ${lang.admin_prohibitDialog1}';
      if (!_expression.hasMatch(value))
        return '* ${lang.admin_prohibitDialog2}';
      if (_expression.hasMatch(value) &&
          (int.tryParse(value)! < 1 || int.tryParse(value)! > 7))
        return '* ${lang.admin_prohibitDialog3}';
      if (_expression.hasMatch(value) &&
    ...
    String? reasonValidation(String? value) {
      if (value!.isEmpty ||
          value.replaceAll(' ', '') == '' ||
          value.trim() == '') return '* ${lang.admin_prohibitDialog4}';
      if (value.length < 20 || value.length > 300)
        return '* ${lang.admin_prohibitDialog5}';
      return null;
    }
                      ...
                      Container(
                          ...
                          child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(lang.admin_prohibitDialog6,
                          ...
                          child: SingleChildScrollView(
                            ...
                            Padding(
                                ...
                                child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        hintText: lang.admin_prohibitDialog7,
                                        border: const OutlineInputBorder(),
                                        labelText: lang.admin_prohibitDialog7,
                            ...
                            Padding(
                                ...
                                child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        hintText: lang.admin_prohibitDialog8,
                                        border: const OutlineInputBorder(),
                                        labelText: lang.admin_prohibitDialog8,
                                        floatingLabelBehavior:
                                            FloatingLabelBehavior.always),
                                    maxLength: 1,
                            ...
                            CheckboxListTile(
                                ...
                                title: Text(lang.admin_prohibitDialog9,
                                    style:
