...
class NotificationButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int myNumOfRepliesRemoved = myProfile.myNumOfRepliesRemovedNotifs;
    ...
    return ConstrainedBox(
        constraints: BoxConstraints(maxHeight: 50.0, maxWidth: 45.0),
        child: FittedBox(
            fit: BoxFit.contain,
            child: IconButton(
                onPressed: () {
