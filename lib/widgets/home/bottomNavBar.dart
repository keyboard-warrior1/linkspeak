...
class _BottomNavBarState extends State<BottomNavBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final BottomNavigationBarItem _feed = BottomNavigationBarItem(
        label: lang.widgets_home1,
        icon: const Icon(customIcons.MyFlutterApp.feed));
    final BottomNavigationBarItem _spotlight = BottomNavigationBarItem(
        label: lang.widgets_home2,
        icon: const Icon(customIcons.MyFlutterApp.spotlight, size: 30.0));
    final BottomNavigationBarItem _newPost = BottomNavigationBarItem(
        label: lang.widgets_home3,
        icon: const Icon(customIcons.MyFlutterApp.add_cross_outlined_symbol));
    final BottomNavigationBarItem _clubs = BottomNavigationBarItem(
        label: lang.widgets_home4,
        icon: const Icon(customIcons.MyFlutterApp.clubs));
    final BottomNavigationBarItem _chats = BottomNavigationBarItem(
        label: lang.widgets_home5,
        icon: Stack(children: <Widget>[
          Center(child: const Icon(customIcons.MyFlutterApp.chats)),
    ...
    final BottomNavigationBar _navBar = BottomNavigationBar(
        ...
        items: [_feed, _spotlight, _newPost, _clubs, _chats]);
    ...
    return Align(
        ...
        child: AnimatedContainer(
            ...
            height: (viewMode == View.normal && showbar) ? 68.0 : 0.0,
            child: _sizedBox));
  }
}
