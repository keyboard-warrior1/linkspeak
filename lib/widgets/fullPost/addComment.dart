...
class _AddCommentState extends State<AddComment> {
  ...
  Future<void> _choose(String myUsername, String postID, dynamic lang) async {
  ...
  Widget build(BuildContext context) {
    ...
    String? _validateComment(String? value) {
      if ((value!.isEmpty ||
              ...
              value.trim() == '') &&
          !containsMedia) {
        return lang.widgets_fullPost1;
      }
      if (value.length > 1500) {
        return lang.widgets_fullPost2;
      }
      return null;
    }
        ...
        child: TypeAheadFormField<MiniProfile>(
            ...
            textFieldConfiguration: TextFieldConfiguration(
                ...
                decoration: InputDecoration(
                    hintText: lang.widgets_fullPost6,
                    counterText: '',
    ...
    final Widget _addComment =
      ...
      if (!containsMedia && !kIsWeb)
        IconButton(
            onPressed: () => _choose(_username, postID, lang),
      ...
      TextButton(
          ...
          child: (isLoading)
              ...
              : Center(
                  child: Text(lang.widgets_fullPost7,
                      style: TextStyle(
                  ...
                  children: <Widget>[
                      Center(
                          child: Container(
                              ...
                              child: Text(lang.widgets_fullPost8,
                                  softWrap: true,
                                  style: const TextStyle(
