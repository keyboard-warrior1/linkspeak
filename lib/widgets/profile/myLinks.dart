...
class _MyLinksState extends State<MyLinks> {
  ...
  Future<void> getMyLinks(
    ...
    final myFullLinks = await myUser.collection('Links').get();
    final fullLinkDocs = myFullLinks.docs;
    fullLinks = fullLinkDocs;
    final myLinks =
        myUser.collection('Links').orderBy('date', descending: true).limit(20);
  ...
  void initState() {
    ...
    final setMyLinks = profileNo.setMyLinks;
  ...
  Widget build(BuildContext context) {
    ...
    final int numOfLinks = myProfile.getNumberOflinks;
    const Widget emptyBox = SizedBox(height: 0, width: 0);
    return (numOfLinks == 0)
        ? SafeArea(
            child:
                Column(mainAxisAlignment: MainAxisAlignment.start, children: [
            SettingsBar(lang.widgets_profile11_title),
            const Spacer(),
            Icon(Icons.person_add_alt, color: Colors.grey.shade300, size: 85.0),
            ...
            Center(
                child: OptimisedText(
                    ...
                    child: Text(lang.widgets_profile12,
                        style: TextStyle(
                            color: Colors.grey.shade400, fontSize: 25.0)))),
            const Spacer()
          ]))
        : GestureDetector(
                                  ...
                                  Padding(
                                      ...
                                      child: TextField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              hintText: lang.widgets_profile13,
                                    ...
                                    Expanded(
                                        child: Noglow(
                                          ...
                                          ...userSearchResults
                                              .take(20)
                                              .map((result) {
                                            final int index = userSearchResults
                                                .indexOf(result);
                                            final current =
