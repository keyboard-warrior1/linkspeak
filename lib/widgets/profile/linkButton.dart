            ...
            child: TextButton(
                onPressed: () {
                  if (isLoading) {
                    ...
                    if (imLinkedToThem) {
                      _showDialog(lang.widgets_profile3, _unlink);
                    }
                    if (linkRequestSent) {
                      _showDialog(lang.widgets_profile4, _cancelRequest);
                    }
                ...
                child: (isLoading)
                    ...
                    : Text(
                        (imLinkedToThem)
                            ? lang.widgets_profile5
                            : (linkRequestSent)
                                ? lang.widgets_profile6
                                : lang.widgets_profile7,
