...
class _ReportDialogState extends State<ReportDialog> {
  ...
  Future<void> report(
    ...
    void _showSnack() => ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        ...
        content: ReportSnack(lang.widgets_auth55)));
