...
class _LogInAuthBoxState extends State<LogInAuthBox> {
  ...
  Future<void> _signIn(
      ...
      dynamic setPrimary,
      dynamic setAccent,
      dynamic setLikeColor, dynamic lang) async {
    ...
    try {
      ...
      if (!users.docs.any((user) => user.id == username)) {
        ...
        await firestore
          ...
          if (status == 'Banned') {
            EasyLoading.dismiss();
            _showDialog(Icons.help, Colors.blue, lang.widgets_auth7,
                lang.widgets_auth8, null);
          } else {
            auth
              ...
              if (!user.user!.emailVerified) {
                EasyLoading.dismiss();
                _showDialog(Icons.help, Colors.blue, lang.widgets_auth9,
                    lang.widgets_auth10, user.user!.sendEmailVerification);
                ...
                if (setUp == 'false') {
                  ...
                  if (widget.inSwitch) {
                    ...
                    _users.doc(username).set({
                      ...
                      _showDialog(Icons.cancel, Colors.red, lang.clubs_create14,
                          lang.clubs_create15, null);
                    });
                  }
                }
              }
  ...
  Widget build(BuildContext context) {
    ...
    final passwordValidator =
        MultiValidator([RequiredValidator(errorText: lang.widgets_auth12)]);
    String? usernameValidator(String? value) {
      ...
      if (value!.isEmpty ||
          value.replaceAll(' ', '') == '' ||
          value.trim() == '') return lang.widgets_auth4;
      if (value.length < 2 || value.length > 30) return lang.widgets_auth5;
      if (!_exp.hasMatch(value)) return lang.widgets_auth5;
      if (_hitlerexp.hasMatch(value)) return lang.widgets_auth5;
      if (filter.hasProfanity(value)) return lang.widgets_auth5;
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                    ...
                                    child: TextButton(
                                        ...
                                        child: Text((widget.inSwitch) ? lang.widgets_auth17 : lang.widgets_auth18,
                                            style: TextStyle(
                                                fontSize: 19.0,
                                                color: (widget.inSwitch)
                                                    ? Colors.white
