                                ...
                                if (isSent) {
                                  ...
                                  if (isLoading) {
                                    ...
                                    if (widget.isSpotlight) {
                                      sendFlare(_myUsername, widget.flarePoster,
                                          widget.collectionID, widget.flareID);
                                    } else {
                                  ...
                                  ? SizedBox(
                                      ...
                                      child: Center(
                                          child: CircularProgressIndicator(
                                              color: _accentColor,
                                              strokeWidth: 1.50)))
                                  : Text((isSent) ? 'Sent' : 'Send', style: TextStyle(color: (isSent) ? _primaryColor : Colors.white, fontWeight: FontWeight.bold, fontSize: 15.0))))
                      : emptyBox);
        });
  }
}
