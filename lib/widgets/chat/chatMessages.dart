...
class _ChatMessagesState extends State<ChatMessages> {
  ...
  String _dateConverter(dynamic date, String locale) {
    ...
    final month = DateFormat('MMMM dd', locale);
    final year = DateFormat('MMMM dd yyyy', locale);
    if (_withinYear) {
  ...
  Widget buildSeperator(
          dynamic theDate, Color _primaryColor, String langCode) =>
      Container(
              ...
              children: <Widget>[
                Container(
                    ...
                    child: Container(
                        ...
                        child: Text("${_dateConverter(theDate, langCode)}",
                                ...
                                TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      final String friendMessage =
                                          General.giveDeletedDisplayMessage(
                                              targetLang);
  ...
  _showFirst(
      ...
      required final String myLangCode}) {
    final lang = General.language(context);
    showDialog(
        context: context,
        builder: (_) {
