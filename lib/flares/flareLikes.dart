...
class FlareLikes extends StatefulWidget {
  final String poster;
  ...
  @override
  State<FlareLikes> createState() => _FlareLikesState();
}

class _FlareLikesState extends State<FlareLikes> {
            ...
            children: <Widget>[
              ...
              Container(
                  ...
                  child: Row(children: <Widget>[
                    Text(lang.flares_likes1,
                        style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 20,
                            color: Colors.black)),
                    Text('${General.optimisedNumbers(widget.numOfLikes)}',
                        style:
