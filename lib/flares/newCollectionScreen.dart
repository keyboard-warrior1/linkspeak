...
class _NewFlareCollectionScreenState extends State<NewFlareCollectionScreen> {
  ...
  String? titleValidation(String? value) {
    if ((value!.isEmpty ||
        value.replaceAll(' ', '') == '' ||
        value.trim() == '')) {
      return 'Please provide a valid collection title';
    }
    if (value.length > 75) {
      return 'Titles can be between 1-75 characters';
    }
    return null;
  }
      ...
      showModalBottomSheet(
          ...
          builder: (_) {
            final ListTile _choosephotoGallery = ListTile(
                ...
                onTap: () => _choose(_primarySwatch, _accentColor));
            final ListTile _camera = ListTile(
                ...
                onTap: () {
                  if (assets.length < 60)
                    _chooseCamera(_primarySwatch, _accentColor);
                });
              ...
              SizedBox(
                  ...
                  child: Form(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            const SettingsBar('New collection'),
                            Expanded(
                                child: Noglow(
                                    child: ListView(
                                ...
                                child: TextButton(
                                    ...
                                    child: (isLoading)
                                        ? CircularProgressIndicator(
                                            color: _accentColor,
                                            strokeWidth: 1.50)
                                        : Text('Release', style: TextStyle(fontSize: 35.0, color: _accentColor))))
                          ]))),
