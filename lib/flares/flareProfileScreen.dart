                          ...
                          child: Builder(builder: (context) {
                            ...
                            return Builder(builder: (context) {
                              ...
                              return isBanned && !imManagement
                                  ? buildCantShow(Icons.person_off,
                                                                    ...
                                                                    tabs: [
                                                                      Container(
                                                                          height:
                                                                              45,
                                                                          child:
                                                                              const Center(child: const Text('Collections', textAlign: TextAlign.center, style: const TextStyle(fontSize: 19.0))))
                                                                    ]),
                                                                FlareProfileTab(
                                                                    _controller)
                                                              ]))),
...
class _FlareBoxState extends State<FlareBox> {
  ...
  Widget buildCancelButton() => GestureDetector(
      onTap: () {
        ...
        children: <Widget>[
          ...
          Row(
              ...
              children: [
                ...
                if (widget.viewMode == ViewMode.edit) buildCancelButton(),
          ...
          Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                giveStatWidget(numOfFlare, 'Flares'),
                _widthBox,
                giveStatWidget(numOfLikes, 'Likes'),
                _widthBox,
                giveStatWidget(numOfViews, 'Views')
              ])
        ]);
  }
}
