...
class _FlareTabWidgetState extends State<FlareTabWidget>
  ...
  Future<void> _choose(Color primaryColor, Color accentColor, String myUsername,
      String _collectionID, String _collectionName) async {
  ...
  Future<void> _chooseCamera(Color primaryColor, Color accentColor,
      String myUsername, String _collectionID, String _collectionName) async {
    Navigator.pop(context);
