...
enum TheVisibility { public, private }
...
abstract class Profile {
  ...
  set setActivity(String activity) => _activity = activity;
  set setStatus(String status) => _status = status;
  set setHasSpotlight(bool hasSpotlight) => _hasSpotlight = hasSpotlight;
  set setPosts(List<Post> posts) => _posts = posts;
  set setPostIDs(List<String> postIds) => _postIDs = postIds;
  set setLinks(List<Profile> links) => _links = links;
  set setlinkIDs(List<String> linkIds) => _linkIDs = linkIds;
  set setLinkedTos(List<Profile> linkedTos) => _linkedTo = linkedTos;
  set setLinkedIDs(List<String> linkedIds) => _linkedIDs = linkedIds;
  set setBlockedIDs(List<String> blockedIds) => _blockedIDs = blockedIds;
  set setBlockedUsers(List<Profile> blockedUsers) =>
      _blockedUsers = blockedUsers;
  set setTopics(List<String> topics) => _topics = topics;
  set setProfileImage(String imgUrl) => _profileImageUrl = imgUrl;
  set setProfileBanner(String bannerUrl) => _profileBannerUrl = bannerUrl;
