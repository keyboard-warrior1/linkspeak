    ...
    return Column(
        ...
        children: <Widget>[
          ...
          Row(
              ...
              children: <Widget>[
                const Spacer(),
                Text(condition ? clubName : lang.clubs_screen3,
                    style: TextStyle(
                        fontSize: 20.0,
          ...
          Row(
              ...
              children: <Widget>[
                GestureDetector(
                    ...
                    child: Text(
                        condition
                            ? '${General.optimisedNumbers(numOfMembers)} ${lang.clubs_screen4}'
                            : '',
