...
class _CreateClubScreenState extends State<CreateClubScreen> {
  ...
  Future<void> _choose(
      String clubName, Color primaryColor, dynamic lang) async {
    ...
    if (getClubName.exists) {
      ...
      if (myImgUrl != 'none') {
        ...
        if (fileSize > 30000000) {
          ...
          _showDialog(Icons.info_outline, Colors.blue, lang.clubs_create10,
              lang.clubs_create11);
        } else {
          ...
          await FlutterNsfw.getPhotoNSFWScore(filePath).then((result) async {
            if (result > 0.759) {
              ...
              _showDialog(Icons.info_outline, Colors.blue, lang.clubs_create12,
                  lang.clubs_create13);
            } else {
              ...
              await storage
                ...
                _showDialog(Icons.cancel, Colors.red, lang.clubs_create16,
                    lang.clubs_create17);
              });
            }
          });
        ...
        batch.commit().then((value) {
          ...
          _showDialog(Icons.cancel, Colors.red, lang.clubs_create18,
              lang.clubs_create19);
        });
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    String? _validateBio(String? value) {
      if (value!.isEmpty ||
          value.replaceAll(' ', '') == '' ||
          value.trim() == '') {
        return '* ${lang.clubs_create1}';
      }
      if (value.length > 2000) {
        return '* ${lang.clubs_create2}';
      }
      return null;
    }
    ...
    String? usernameValidator(String? value) {
      ...
      if (value!.isEmpty ||
          value.replaceAll(' ', '') == '' ||
          value.trim() == '') return '* ${lang.clubs_create3}';
      if (value.length < 2 || value.length > 30)
        return '* ${lang.clubs_create4}';
      if (!_exp.hasMatch(value)) return '* ${lang.clubs_create5}';
      if (_exp2.hasMatch(value)) return '* ${lang.clubs_create6}';
      if (usernameDocs.isNotEmpty) {
        if (usernameDocs.any((element) => element.id == value))
          return '* ${lang.clubs_create7}';
      }
            ...
            child: Column(
                ...
                children: <Widget>[
                  TextButton(
                      ...
                      child: Text(lang.clubs_create20,
                  ...
                  if (myImgUrl != 'none')
                    TextButton(
                        ...
                        style: const ButtonStyle(
                            splashFactory: NoSplash.splashFactory),
                        child: Text(lang.clubs_create21,
                            style: const TextStyle(
                                fontWeight: FontWeight.normal,
                                decoration: TextDecoration.none,
                                fontFamily: 'Roboto',
                ...
                child: Form(
                    ...
                    child: SizedBox(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              SettingsBar(lang.clubs_create22),
                              _heightBox,
                              Expanded(
                                  child: Noglow(
