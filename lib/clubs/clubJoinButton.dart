                              ...
                              Row(
                                  ...
                                  children: <Widget>[
                                    TextButton(
                                        ...
                                        child: Text(lang.clubs_joinButton1,
                                    ...
                                    TextButton(
                                        ...
                                        child: Text(lang.clubs_joinButton2,
                                            style: const TextStyle(
                                                color: Colors.red)))
                                  ])
                            ]))));
            ...
            child: TextButton(
                onPressed: () {
                  if (isLoading) {
                    ...
                    if (imLinkedToThem) {
                      _showDialog(lang.clubs_joinButton3, _unlink);
                    }
                    if (linkRequestSent) {
                      _showDialog(lang.clubs_joinButton4, _cancelRequest);
                    }
                ...
                child: (isLoading)
                    ...
                    : Text(
                        (imLinkedToThem)
                            ? lang.clubs_joinButton5
                            : (linkRequestSent)
                                ? lang.clubs_joinButton6
                                : lang.clubs_joinButton7,
                        style: TextStyle(
                            fontSize: 18.0,
                            color:
