...
class _ManageClubScreenState extends State<ManageClubScreen> {
  ...
  String? maxDailyValidator(String? value) {
    ...
    if (value!.isEmpty || value.replaceAll(' ', '') == '' || value.trim() == '')
      return 'Number of maximum posts is required';
    if (!_expression.hasMatch(value)) return 'Invalid maximum posts';
    if (_expression.hasMatch(value) &&
        (int.tryParse(value)! < 1 || int.tryParse(value)! > 50))
      return 'Max daily posts can be between 1-50';
    if (_expression.hasMatch(value) &&
      ...
      case ClubVisibility.private:
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: const VisSnack(Icons.lock_outline, 'private', true),
          ),
        );
        break;
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: const VisSnack(
                customIcons.MyFlutterApp.globe_no_map, 'public', true),
          ),
        );
        break;
      case ClubVisibility.hidden:
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: primarySwatch,
            content:
                const VisSnack(customIcons.MyFlutterApp.hidden, 'hidden', true),
          ),
        );
        break;
    }
  ...
  Widget buildMyDialog(Color _primaryColor) => Center(
      child: Container(
                ...
                if (!kIsWeb)
                  TextButton(
                      onPressed: () {
                        ...
                        _choose(widget.clubName, _primaryColor);
                      },
      ...
      Padding(
          ...
          child: DropdownButton(
              ...
              items: [
                ...
                buildDropItem(_changeLocalVis, _primaryColor, 'Hidden',
  ...
  Widget buildSwitch(Color _primaryColor, bool value, String label,
      ...
      SwitchListTile(
          ...
          onChanged: onChanged);
  Widget buildBannedTile(Object? _clubName) => ListTile(
      onTap: () {
      ...
      title: Row(
          ...
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            const Text('Banned members', style: TextStyle(color: Colors.black))
          ]));
  Widget buildAdminTile(Object? isFounder, Object? _clubName) => ListTile(
      onTap: () {
      ...
      title: Row(
          ...
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            const Text('Admins', style: TextStyle(color: Colors.black))
          ]));
  @override
                                    ...
                                    children: <Widget>[
                                      ...
                                      Opacity(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: (isLoading) ? CircularProgressIndicator(color: _accentColor, strokeWidth: 1.50) : Text('Save', style: TextStyle(fontSize: 35.0, color: _accentColor))))
                                    ])));
                      });
                    })))));
  }
