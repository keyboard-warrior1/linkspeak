  ...
  void _addPost({
      ...
      if (invalidSizeVid.isNotEmpty || invalidSizeIMG.isNotEmpty) {
        ...
        if (last24hrs.length >= maxDailyPosts) {
          ...
          _showDialog(
            ...
            Colors.blue,
            lang.clubs_newPost7,
            "${lang.clubs_newPost8} ${maxDailyPosts.toString()} ${lang.clubs_newPost9}",
          );
        } else {
          if (!kIsWeb) {
    ...
    if (isLoading) {
      ...
      if (canSubmit && !isLoading) {
        ...
        EasyLoading.show(status: lang.clubs_newPost12, dismissOnTap: false);
        _sendPost();
      } else if (invalidVid) {
        setState(() {
          isLoading = false;
                ...
                child: SizedBox(
                    ...
                    child: Form(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              SettingsBar(lang.clubs_newPost15),
                                              ...
                                              children: <Widget>[
                                                ...
                                                Container(
                                                    ...
                                                    child: ElevatedButton(
                                                        ...
                                                        child: Center(child: Text(lang.clubs_newPost18, style: TextStyle(color: _accentColor, fontSize: 30.0)))))
                                              ])
                                        ])),
                                    const BoardTab(),
                                    const BranchTab()
          ...
          if (!clubTopicsAdded)
            Container(
                child: GestureDetector(
                    ...
                    child: TopicChip(lang.clubs_newPost23,
                        Icon(Icons.add, color: _accentColor), () {
                      if (isLoading) {
                      } else {
                        addMyTopics(_clubTopics);
                          ...
                          Container(
                              ...
                              child: Noglow(
                                  child: ListView(
                                    ...
                                    if (!clubTopicsAdded)
                                      buildAdder(lang.clubs_newPost23,
                                          Icons.add, _addClubTopics)
                                  ]))),
      ...
      Container(
          ...
          child: Noglow(
              child: ListView(
                ...
                if (!clubTopicsAdded)
                  buildAdder(lang.clubs_newPost23, Icons.add, _addClubTopics)
              ]))),
