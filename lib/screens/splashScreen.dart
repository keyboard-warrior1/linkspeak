...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget buildNonStackedConsent() => Container(
  ...
  Widget buildNoneLogin() {
    ...
    return SafeArea(
        child: Column(
          ...
          buildLinkspeak(),
          spacer,
          buildNonStackedRetry(),
          consent
        ]));
  }

  Widget buildMosaicLogin() {
    const spacer = const Spacer();
  ...
  Widget buildRainLogin() {
    ...
    return ParallaxRain(
      ...
      child: buildNoneLogin(),
    );
  }

  Widget buildTheme(String themeType) {
    final mosaicTheme = buildMosaicLogin();
    final rainyTheme = buildRainLogin();
    final noTheme = buildNoneLogin();
    if (themeType == 'Mosaic') {
      return mosaicTheme;
