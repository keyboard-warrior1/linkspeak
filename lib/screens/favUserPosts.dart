...
class FavUserPosts extends StatefulWidget {
  const FavUserPosts();
  @override
  _FavUserPostsState createState() => _FavUserPostsState();
}

class _FavUserPostsState extends State<FavUserPosts>
  ...
  Widget build(BuildContext context) {
    ...
    final setFavPosts =
        Provider.of<MyProfile>(context, listen: false).setFavPostas;
    final clearFavPosts =
        Provider.of<MyProfile>(context, listen: false).clearFavPosts;
                      ...
                      RefreshIndicator(
                        ...
                        child: Noglow(
                          child: ListView.separated(
                            shrinkWrap: true,
                            key: PageStorageKey<String>('FavoriteUsersPosts'),
