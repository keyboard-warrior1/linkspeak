...
class LikedUserPosts extends StatefulWidget {
  const LikedUserPosts();
  @override
  _LikedUserPostsState createState() => _LikedUserPostsState();
}

class _LikedUserPostsState extends State<LikedUserPosts>
  ...
  Widget build(BuildContext context) {
    ...
    final clearLikedPosts =
        Provider.of<MyProfile>(context, listen: false).clearLikedPosts;
    final myUsername =
        Provider.of<MyProfile>(context, listen: false).getUsername;
                      ...
                      RefreshIndicator(
                        ...
                        child: Noglow(
                          child: ListView.separated(
                            shrinkWrap: true,
                            key: PageStorageKey<String>('LikedUsersPosts'),
