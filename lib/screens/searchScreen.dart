                          ...
                          decoration: InputDecoration(
                                          ...
                                          child: Column(
                                              ...
                                              children: [
                                                const Icon(
                                                    ...
                                                    color: Colors.black),
                                                Text(lang.screens_searchScreen1,
                              ...
                              suffixIcon: (_clearable)
                                  ? IconButton(
                                      ...
                                      tooltip:
                                          lang.admin_controlDailyLoginSearch2,
                                      onPressed: () {
                                        setState(() {
                              ...
                              hintText: lang.screens_searchScreen2,
                      ...
                      child: ListView(
                        ...
                        Column(children: <Widget>[
                          if (_textController.value.text.isEmpty)
                            Container(
                                child: Center(
                                    child: Text(lang.screens_searchScreen3,
                                        style: const TextStyle(
                                            color: Colors.grey)))),
                          if (_textController.value.text.isNotEmpty &&
                      ...
                      child: ListView(
                        ...
                        Column(children: <Widget>[
                          if (_textController.value.text.isEmpty)
                            Container(
                                child: Center(
                                    child: Text(lang.screens_searchScreen5,
                                        style: const TextStyle(
                                            color: Colors.grey)))),
                          if (_textController.value.text.isNotEmpty &&
                      ...
                      child: ListView(
                        ...
                        Column(children: <Widget>[
                          if (_textController.value.text.isEmpty)
                            Container(
                                child: Center(
                                    child: Text(lang.screens_searchScreen6,
                                        style: const TextStyle(
                                            color: Colors.grey)))),
                          if (_textController.value.text.isNotEmpty &&
                      ...
                      child: ListView(
                        ...
                        Column(children: <Widget>[
                          ...
                          if (_textController.value.text.isEmpty &&
                            ...
                            Container(
                                child: Center(
                                    child: Text(lang.screens_searchScreen4,
                                        style: const TextStyle(
                                            color: Colors.grey)))),
                          if (_textController.value.text.isNotEmpty &&
