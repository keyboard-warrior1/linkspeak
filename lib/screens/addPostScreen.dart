                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                child: Center(child: isLoading ? SizedBox(height: 15, width: 15, child: CircularProgressIndicator(color: _accentColor, strokeWidth: 1.50)) : Text('Publish', style: TextStyle(color: _accentColor, fontSize: 30.0)))))
                                      ])
                                ])),
                            const BoardTab(),
                            const BranchTab()
