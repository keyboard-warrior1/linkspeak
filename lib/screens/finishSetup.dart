...
class _SetupProfileScreenState extends State<SetupProfileScreen> {
  ...
  Future<void> updateUser(BuildContext context, String myUsername) async {
    ...
    if (_newTopicNames.length < 5) {
      ...
      _showDialog(Icons.info_outline, Colors.blue, lang.screens_editProfile5,
          lang.screens_finishSetup1);
    } else {
      ...
      if (_myImgUrl != 'none') {
        ...
        if (fileSize > 30000000) {
          ...
          EasyLoading.show(
              status: lang.screens_finishSetup2, dismissOnTap: false);
        ...
        EasyLoading.show(
          status: lang.screens_finishSetup2,
          dismissOnTap: false,
        );
        for (var topicName in _newTopicNames) {
          await handleTopic(topicName);
  ...
  Widget build(BuildContext context) {
    ...
    final Widget _bar = SettingsBar(lang.screens_finishSetup4, null, false);
                  ...
                  child: NestedScroller(
                      ...
                      child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            counterText: '',
                            hintText: lang.screens_finishSetup5,
