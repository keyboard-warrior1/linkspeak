...
class _LikedPostScreenState extends State<LikedPostScreen> {
  final ScrollController _scrollController = LikedPostScreen.scrollController;
  ...
  Future<void> getLikedPosts(
    ...
    void Function(List<Post>) setLikedPosts,
  ) async {
  ...
  void initState() {
    super.initState();
    final likedPostIDs =
        Provider.of<MyProfile>(context, listen: false).getLikedPostIDs;
    final setLikedPosts =
        Provider.of<MyProfile>(context, listen: false).setLikedPostas;
    final myUsername =
        Provider.of<MyProfile>(context, listen: false).getUsername;
    _getLikedPosts = getLikedPosts(myUsername, likedPostIDs, setLikedPosts);
    _scrollController.addListener(() async {
      if (_scrollController.position.pixels ==
        ...
        if (isLastPage) {
          ...
          if (!isLoading) {
            getMorePosts(myUsername, likedPostIDs, setLikedPosts);
          }
        }
      }
    });
  ...
  Widget build(BuildContext context) {
    ...
    final likedPostIDs = Provider.of<MyProfile>(context).getLikedPostIDs;
    final setLikedPosts =
        Provider.of<MyProfile>(context, listen: false).setLikedPostas;
            ...
            return SafeArea(
              child: SizedBox(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: <Widget>[
                    const SettingsBar("Posts you've liked"),
                    const Spacer(),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () => setState(() => _getLikedPosts =
                              getLikedPosts(
                                  myUsername, likedPostIDs, setLikedPosts)),
                          child: Center(
                            child: Text(
                              'Retry',
                              style: TextStyle(
                          ...
                          Expanded(
                            child: NotificationListener<
                              ...
                              child: ListView.separated(
                                shrinkWrap: true,
                                key: PageStorageKey<String>('LikedsPosts'),
