                      ...
                      if (_formKey.currentState!.validate()) {
                        if (_isLoading) {
                          ...
                          if (users.docs.any((user) =>
                              user.id == userNameControl.value.text)) {
                            _showDialog(
                              Icons.cancel,
                              Colors.red,
                              'Username exists',
                            ...
                            if (widget.isGmail) {
                              prefs
                                  .setString('GMAIL', '${widget.emailXid}')
                                  .then((value) {});
                            } else {
                              prefs
                                  .setString('FB', '${widget.emailXid}')
                                  .then((value) {});
                            }
                            ...
                            batch.set(
                                    ...
                                    '${userNameControl.value.text.trim()}'),
                                {
                                  ...
                                  'Status': 'Allowed',
                                  'Name':
                                      (widget.isGmail) ? 'gmail account' : 'FB',
                                  'Surname':
                                      (widget.isGmail) ? 'gmail account' : 'FB',
                                  'Age':
                                      (widget.isGmail) ? 'gmail account' : 'FB',
                            ...
                            batch.commit().then((value) {
                              Provider.of<MyProfile>(context, listen: false)
                                  .setMyUsername(userNameControl.value.text);
